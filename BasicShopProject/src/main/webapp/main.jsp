...
<body>
	...
	<div class="container">
		<button type="button" class="btn btn-default" id="a1" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
		  Popover on left
		</button>
        <h3>나폴레옹은 이렇게 말했다.</h3>
